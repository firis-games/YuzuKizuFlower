...
import firis.yuzukizuflower.tileentity.YKTileBaseManaPool;
...
public class YKGuiContainerBoxedJadedAmaranthus extends GuiContainer{
...
protected IInventory invTileEntity = null;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		ResourceLocation GuiTextures = 
				new ResourceLocation("yuzukizuflower", "textures/gui/boxed_jaded_amaranthus.png");
        ...
        */
        ...
        this.drawTexturedModalRect(x + 40, y + 41, 192, 0, l + 1, 16);
	...
	private int getProgressScaled(int pixels)
    {
        ...
        int i = ((YKTileBoxedJadedAmaranthus) this.invTileEntity).getTimer();
        int j = ((YKTileBoxedJadedAmaranthus) this.invTileEntity).getMaxTimer();
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
		...
		TextComponentTranslation langtext = 
				new TextComponentTranslation("gui.boxed_jaded_amaranthus.name", new Object[0]);
