...
public class YKGuiContainerBoxedBrewery extends GuiContainer {
	...
	protected BreweryInventory iinventory;

	public YKGuiContainerBoxedBrewery(IInventory inventory, InventoryPlayer playerInv) {
		
		super(new YKContainerBoxedBrewery(inventory, playerInv));

		this.iinventory = (BreweryInventory) inventory;
		
		
		// GUIテクスチャ
		this.guiTextures = new ResourceLocation("yuzukizuflower", "textures/gui/boxed_brewery.png");

		// GUIタイトル
		this.guiTitle = "gui.boxed_brewery.name";
