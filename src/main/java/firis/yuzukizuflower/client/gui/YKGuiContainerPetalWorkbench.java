...
public class YKGuiContainerPetalWorkbench extends GuiContainer {
	...
	protected PetalInventory iinventory;

	public YKGuiContainerPetalWorkbench(IInventory inventory, InventoryPlayer playerInv) {
		
		super(new YKContainerPetalWorkbench(inventory, playerInv));

		this.iinventory = (PetalInventory) inventory;
		
		
		// GUIテクスチャ
		this.guiTextures = new ResourceLocation("yuzukizuflower", "textures/gui/petal_workbench.png");

		// GUIタイトル
		this.guiTitle = "gui.petal_workbench.name";
	...
	public void drawWaterGage(int x, int y) {
        ...
        //ゲージを描く
		YKWaterFluidHandler fluidHandler = (YKWaterFluidHandler) this.iinventory.getFluidHandler();
