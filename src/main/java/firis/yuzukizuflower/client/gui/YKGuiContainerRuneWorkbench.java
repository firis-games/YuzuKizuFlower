...
public class YKGuiContainerRuneWorkbench extends GuiContainer {
	...
	protected RuneCraftInventory iinventory;

	public YKGuiContainerRuneWorkbench(IInventory inventory, InventoryPlayer playerInv) {
		
		super(new YKContainerRuneWorkbench(inventory, playerInv));

		this.iinventory = (RuneCraftInventory) inventory;
		
		
		// GUIテクスチャ
		this.guiTextures = new ResourceLocation("yuzukizuflower", "textures/gui/rune_workbench.png");

		// GUIタイトル
		this.guiTitle = "gui.rune_workbench.name";
