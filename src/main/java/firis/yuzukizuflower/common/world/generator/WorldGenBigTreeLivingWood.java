...
public class WorldGenBigTreeLivingWood extends WorldGenAbstractTree {
    ...
    List<WorldGenBigTreeLivingWood.FoliageCoordinates> foliageCoords;

    public WorldGenBigTreeLivingWood(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenBigTreeLivingWood.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenBigTreeLivingWood.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenBigTreeLivingWood.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), blockLeaves.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenBigTreeLivingWood.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
    ...
    void generateLeafNodeBases()
    {
        for (WorldGenBigTreeLivingWood.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
            ...
            {
                this.limb(blockpos, worldgenbigtree$foliagecoordinates, blockLog);
            }
        }
    }
