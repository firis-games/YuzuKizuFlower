...
public class YKContainerBoxedEntropinnyum extends YKContainerBaseBoxedFuncFlower {
	 ...
	 * @param playerInv
	 */
	public YKContainerBoxedEntropinnyum(IInventory iTeInv, IInventory playerInv) {
