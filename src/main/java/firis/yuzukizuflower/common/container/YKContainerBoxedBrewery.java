...
public class YKContainerBoxedBrewery extends Container {

	protected BreweryInventory inventory; 
	
	/**
	 * コンストラクタ
	 */
	public YKContainerBoxedBrewery(IInventory iinv, InventoryPlayer playerInv) {
		
		inventory = (BreweryInventory) iinv;
		...
		this.addSlotToContainer(new YKSlotInventory(iinv, 16, 16, 77) {
		    ...
		    {
				return BotaniaHelper.recipesBrewery.isCatalyst(stack);
		    }
		});
