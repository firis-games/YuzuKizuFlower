...
public class YKContainerRuneWorkbench extends Container {

	protected RuneCraftInventory inventory; 
	
	/**
	 * コンストラクタ
	 */
	public YKContainerRuneWorkbench(IInventory iinv, InventoryPlayer playerInv) {
		
		inventory = (RuneCraftInventory) iinv;
		...
		this.addSlotToContainer(new YKSlotInventory(iinv, 16, 16, 77) {
		    ...
		    {
				return BotaniaHelper.recipesRuneAltar.isStone(stack);
		    }
		});
