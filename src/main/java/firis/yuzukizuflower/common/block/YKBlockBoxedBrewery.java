 ...
 *
 */
public class YKBlockBoxedBrewery extends BlockContainer {

	public YKBlockBoxedBrewery() {
		super(Material.ROCK);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
    	...
    	//右クリックでGUIを開く
		playerIn.openGui(YuzuKizuFlower.INSTANCE, YKGuiHandler.BOXED_BREWERY,
